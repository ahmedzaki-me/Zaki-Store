...
const SOCIAL_LINKS = [
  ...
  {
    href: "https://www.instagram.com/ahmedzaki11103",
    label: "Instagram",
    icon: (
      <svg role="img" viewBox="0 0 24 24" className="h-6 w-6 fill-current">
...
export default function Footer() {
  return (
    ...
    >
      <div className="relative container mx-auto px-13 py-10 ">
        ...
        <div className="flex flex-col items-center gap-8 sm:flex-row sm:justify-around ">
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <div className="flex items-center justify-between gap-4 p-3 rounded-2xl bg-secondary/50 border border-border">
              {SOCIAL_LINKS.map(({ href, label, icon }) => (
                <a
                  ...
                  aria-label={label}
                  className="transition-transform duration-200 hover:scale-110 hover:text-primary text-foreground"
                >
                  {icon}
                </a>
              ))}
          ...
          <div className="flex flex-col gap-4 text-sm">
            ...
            >
              ...
              <span dir="rtl" className="leading-relaxed">
                Egypt, Alexandria, Under The Sea, Room Number 220
              </span>
            </a>

            <div className="flex items-center flex-col gap-2">
              <Clock className="h-6 w-6 shrink-0" />
              <span>Business Hours: From 2:00PM To 2:00AM</span>
            </div>
      ...
      <div className="font-semibold bg-[#191919] border-t border[#999] text-white/90">
        <div className="container mx-auto px-4 py-6">
          <p dir="ltr" className="text-center text-sm opacity-80">
            Made With Love By:{" "}
            <a
              href="https://ahmedzaki.me"
              target="_blank"
              rel="noopener noreferrer"
              className="font-bold text-primary transition-opacity hover:opacity-90 text-[18px] italic"
            >
              Ahmed Zaki
            </a>{" "}
